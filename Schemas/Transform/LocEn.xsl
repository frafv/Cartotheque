...
<xsl:template match="l:LocationList" mode="Header">
	<xsl:apply-templates select="." mode="ViewTitle">
		...
		<xsl:with-param name="Title">List of Locations</xsl:with-param>
	</xsl:apply-templates>
...
<xsl:template match="l:Country|l:Region|l:City|l:Street">
	...
	<xsl:apply-templates select="." mode="ViewHeader">
		<xsl:with-param name="Subtitle">
			<xsl:if test="$org">(<xsl:apply-templates select="$org" mode="FormatList"/>)</xsl:if>
		</xsl:with-param>
	</xsl:apply-templates>
...
<!--<xsl:template match="l:Country|l:Region|l:City|l:Street" mode="LabelText">
	<xsl:param name="Lang">
		<xsl:apply-templates select="." mode="UILang"/>
	</xsl:param>
